                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          ...
                          theme === "light" || theme === "solarized"
                            ? "bg-gradient-to-r from-blue-400 to-blue-600 text-white shadow hover:shadow-xl"
                            : theme === "dracula"
                              ? "bg-gradient-to-r from-purple-900 to-purple-700 text-white shadow hover:shadow-xl"
                                  ...
                                  : theme === "mh"
                                    ...
                                    : theme === "ps2"
                                      ...
                                      : theme === "nord"
                                        ...
                                        : theme === "snes"
                                          ? "bg-gradient-to-r from-[#ff0000] via-[#ffff00] to-[#00ff00] text-[#4040e0] font-bold border-[#ffa500] shadow-[0_0_15px_rgba(255,165,0,0.3)] hover:shadow-[0_0_20px_rgba(255,165,0,0.5)] animate-pulse [text-shadow:0_1px_2px_rgba(0,0,0,0.25)]"
                                          : fortniteTheme
                      ...
                      >
                        ...
                        <span
                          className={cn("font-medium", theme === "snes" ? "text-[#4040e0]" : "")}
                        >
