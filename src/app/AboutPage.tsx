            ...
            <div>
              ...
              >
                ...
                <li>
                  ...
                  code editor to implement algorithms and see how mathematical concepts translate
                  into code.
                </li>
                <li>
                  <span className="font-medium">Track Your Progress:</span> Monitor your
                  understanding through quizzes and challenges at the end of each section.
                </li>
                <li>
                  <span className="font-medium">Use the Resources:</span> Access additional
                  materials, visualizations, and reference guides to deepen your understanding.
                </li>
              </ol>
            </div>
