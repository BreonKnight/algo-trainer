...
export const pseudocodePatterns: Record<PatternKey, () => JSX.Element> = {
  ...
  "Activity Selection": () => (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold">Activity Selection</h3>
  ...
  "Huffman Coding": () => (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold">Huffman Coding</h3>
      <div className="mb-2 text-xs text-secondary">
  ...
  "Dijkstra": () => (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold">Dijkstra's Algorithm</h3>
      <div className="mb-2 text-xs text-secondary">
