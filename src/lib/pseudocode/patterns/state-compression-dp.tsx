...
export const StateCompressionDPPattern = () => (
  <div>
    <div className="mb-2">
      <span className="text-accent font-bold">State Compression DP Template</span>
    ...
    <div className="mb-2 text-xs text-secondary">
      ...
      Use: State Compression DP problems
    </div>
    ...
    <div className="flex items-start mb-1">
      ...
      <ChevronRight className="w-4 h-4 text-accent mt-1 mr-1" />
      <span>
        <span className="font-semibold text-accent">Process:</span> Implement State Compression DP logic
      </span>
    </div>
    <div className="flex items-start mb-1">
