...
export const StronglyConnectedComponentsPattern = () => (
  <div>
    <div className="mb-2">
      <span className="text-accent font-bold">Strongly Connected Components Template</span>
    ...
    <div className="mb-2 text-xs text-secondary">
      ...
      Use: Strongly Connected Components problems
    </div>
    ...
    <div className="flex items-start mb-1">
      ...
      <ChevronRight className="w-4 h-4 text-accent mt-1 mr-1" />
      <span>
        <span className="font-semibold text-accent">Process:</span> Implement Strongly Connected Components logic
      </span>
    </div>
    <div className="flex items-start mb-1">
