...
export const FibonacciSearchPattern = () => (
  <div>
    <div className="mb-2">
      <span className="text-accent font-bold">Fibonacci Search Template</span>
    ...
    <div className="flex items-start mb-1">
      ...
      <ChevronRight className="w-4 h-4 text-accent mt-1 mr-1" />
      <span>
        <span className="font-semibold text-accent">Process:</span> Implement Fibonacci Search logic
      </span>
    </div>
    <div className="flex items-start mb-1">
